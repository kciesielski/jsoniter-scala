...
class ArrayOfLocalDatesReading extends ArrayOfLocalDatesBenchmark {
  def avSystemGenCodec(): Array[LocalDate] = {
    import com.avsystem.commons.serialization.json._
    import com.github.plokhotnyuk.jsoniter_scala.benchmark.AVSystemCodecs._
    import java.nio.charset.StandardCharsets.UTF_8

    JsonStringInput.read[Array[LocalDate]](new String(jsonBytes, UTF_8))
  }
  ...
  def dslJsonScala(): Array[LocalDate] = {
    import com.github.plokhotnyuk.jsoniter_scala.benchmark.DslPlatformJson._

    dslJsonDecode[Array[LocalDate]](jsonBytes)
  }
